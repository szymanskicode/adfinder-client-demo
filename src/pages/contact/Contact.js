  ...
  return (
    <div id="contact">
      <div className="row">
        ...
        <div className="col col-12 col-lg-6">
          <p className="lead">
            Nasze Centrum Pomocy jest do Państwa dyspozycji od poniedziałku do
            piątku w godzinach: 8:00-18:00.
          </p>
          <p className="display-6 mb-3">
            <small>Adres do korespondencji:</small>
          </p>
          <p className="lead">
            <small>
              Adfinder <br /> ul. Stawowa 178 <br /> 00-000 Wrocław
            </small>
          </p>
          <p className="display-6 mb-3">
          ...
          <p>
            <small className="lead">(+48) 111-222-333</small> <br />{" "}
          ...
          <p>
            <small className="lead">adfinder@example.com</small>
          </p>
        </div>
      </div>
    </div>
